...
public class FU_LI implements org.apache.thrift.TBase<FU_LI, FU_LI._Fields>, java.io.Serializable, Cloneable, Comparable<FU_LI> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FU_LI");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new FU_LIStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new FU_LITupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<FU_INT64> v; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FU_LI.class, metaDataMap);
  }
  ...
  public FU_LI(FU_LI other) {
    ...
    this.pos = other.pos;
    if (other.isSetV()) {
      java.util.List<FU_INT64> __this__v = new java.util.ArrayList<FU_INT64>(other.v.size());
      for (FU_INT64 other_element : other.v) {
        __this__v.add(new FU_INT64(other_element));
      }
      this.v = __this__v;
    }
  }
  ...
  public FU_LI setCtrl(byte ctrl) {
    this.ctrl = ctrl;
    setCtrlIsSet(true);
    return this;
  }
   ...
   * @see FU_LIST_OP
   */
  public FU_LI setOp(@org.apache.thrift.annotation.Nullable FU_LIST_OP op) {
    this.op = op;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<FU_INT64> getVIterator() {
    return (this.v == null) ? null : this.v.iterator();
  }

  public void addToV(FU_INT64 elem) {
    if (this.v == null) {
      this.v = new java.util.ArrayList<FU_INT64>();
    }
    this.v.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<FU_INT64> getV() {
    return this.v;
  }

  public FU_LI setV(@org.apache.thrift.annotation.Nullable java.util.List<FU_INT64> v) {
    this.v = v;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case V:
      if (value == null) {
        ...
        setV((java.util.List<FU_INT64>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof FU_LI)
      return this.equals((FU_LI)that);
    return false;
  }

  public boolean equals(FU_LI that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(FU_LI other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("FU_LI(");
    boolean first = true;
  ...
  private static class FU_LIStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public FU_LIStandardScheme getScheme() {
      return new FU_LIStandardScheme();
    }
  }

  private static class FU_LIStandardScheme extends org.apache.thrift.scheme.StandardScheme<FU_LI> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, FU_LI struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.v = new java.util.ArrayList<FU_INT64>(_list312.size);
                @org.apache.thrift.annotation.Nullable FU_INT64 _elem313;
                for (int _i314 = 0; _i314 < _list312.size; ++_i314)
                {
                  _elem313 = new FU_INT64();
                  _elem313.read(iprot);
                  struct.v.add(_elem313);
                }
                iprot.readListEnd();
              }
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, FU_LI struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.v != null) {
        oprot.writeFieldBegin(V_FIELD_DESC);
        {
          ...
          for (FU_INT64 _iter315 : struct.v)
          {
  ...
  private static class FU_LITupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public FU_LITupleScheme getScheme() {
      return new FU_LITupleScheme();
    }
  }

  private static class FU_LITupleScheme extends org.apache.thrift.scheme.TupleScheme<FU_LI> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FU_LI struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetV()) {
        {
          ...
          for (FU_INT64 _iter316 : struct.v)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FU_LI struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.v = new java.util.ArrayList<FU_INT64>(_list317.size);
          @org.apache.thrift.annotation.Nullable FU_INT64 _elem318;
          for (int _i319 = 0; _i319 < _list317.size; ++_i319)
          {
            _elem318 = new FU_INT64();
            _elem318.read(iprot);
