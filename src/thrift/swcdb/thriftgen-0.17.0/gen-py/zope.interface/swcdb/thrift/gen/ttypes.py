...
class Cells(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i291 in range(_size287):
                        _elem292 = CellPlain()
                        _elem292.read(iprot)
                        self.plain_cells.append(_elem292)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i297 in range(_size293):
                        _elem298 = CellCounter()
                        _elem298.read(iprot)
                        self.counter_cells.append(_elem298)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i303 in range(_size299):
                        _elem304 = CellSerial()
                        _elem304.read(iprot)
                        self.serial_cells.append(_elem304)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.plain_cells is not None:
            ...
            for iter305 in self.plain_cells:
                iter305.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.counter_cells is not None:
            ...
            for iter306 in self.counter_cells:
                iter306.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.serial_cells is not None:
            ...
            for iter307 in self.serial_cells:
                iter307.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i325 in range(_size321):
                        _elem326 = CellValueSerial()
                        _elem326.read(iprot)
                        self.v.append(_elem326)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class ColCells(object):
    ...
    def write(self, oprot):
        ...
        if self.serial_cells is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.serial_cells))
            for iter342 in self.serial_cells:
                iter342.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i347 in range(_size343):
                        _elem348 = CellValueSerial()
                        _elem348.read(iprot)
                        self.v.append(_elem348)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class kCells(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i366 in range(_size362):
                        _elem367 = KCellSerial()
                        _elem367.read(iprot)
                        self.serial_cells.append(_elem367)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.k is not None:
            oprot.writeFieldBegin('k', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.k))
            for iter368 in self.k:
                oprot.writeBinary(iter368)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.cells is not None:
            oprot.writeFieldBegin('cells', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.cells))
            for iter369 in self.cells:
                iter369.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.serial_cells is not None:
            oprot.writeFieldBegin('serial_cells', TType.LIST, 3)
            oprot.writeListBegin(TType.STRUCT, len(self.serial_cells))
            for iter370 in self.serial_cells:
                iter370.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i375 in range(_size371):
                        _elem376 = CellValueSerial()
                        _elem376.read(iprot)
                        self.v.append(_elem376)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class FCells(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i382 in range(_size378):
                        _key383 = iprot.readBinary()
                        _val384 = FCells()
                        _val384.read(iprot)
                        self.f[_key383] = _val384
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i395 in range(_size391):
                        _elem396 = FCellSerial()
                        _elem396.read(iprot)
                        self.serial_cells.append(_elem396)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.f is not None:
            ...
            for kiter397, viter398 in self.f.items():
        ...
        if self.serial_cells is not None:
            oprot.writeFieldBegin('serial_cells', TType.LIST, 3)
            oprot.writeListBegin(TType.STRUCT, len(self.serial_cells))
            for iter400 in self.serial_cells:
                iter400.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class CellsGroup(object):
    ...
    def write(self, oprot):
        ...
        if self.ccells is not None:
            ...
            for kiter414, viter415 in self.ccells.items():
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i427 in range(_size423):
                        _elem428 = CompactResult()
                        _elem428.read(iprot)
                        self.compact.append(_elem428)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
