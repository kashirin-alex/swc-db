...
class Client(object):
    ...
    def sql_select_plain(self, sql):
        ...
        """
        self.send_sql_select_plain(sql)
        return self.recv_sql_select_plain()

    def send_sql_select_plain(self, sql):
        self._oprot.writeMessageBegin('sql_select_plain', TMessageType.CALL, self._seqid)
    ...
    def recv_sql_select_plain(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "sql_select_plain failed: unknown result")
    ...
    def sql_select_counter(self, sql):
        ...
        """
        self.send_sql_select_counter(sql)
        return self.recv_sql_select_counter()

    def send_sql_select_counter(self, sql):
        self._oprot.writeMessageBegin('sql_select_counter', TMessageType.CALL, self._seqid)
    ...
    def recv_sql_select_counter(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "sql_select_counter failed: unknown result")
    ...
    def sql_select_serial(self, sql):
        ...
        """
        self.send_sql_select_serial(sql)
        return self.recv_sql_select_serial()

    def send_sql_select_serial(self, sql):
        self._oprot.writeMessageBegin('sql_select_serial', TMessageType.CALL, self._seqid)
    ...
    def recv_sql_select_serial(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "sql_select_serial failed: unknown result")
    ...
    def update_plain(self, cells, updater_id):
        ...
        """
        self.send_update_plain(cells, updater_id)
        self.recv_update_plain()

    def send_update_plain(self, cells, updater_id):
        self._oprot.writeMessageBegin('update_plain', TMessageType.CALL, self._seqid)
    ...
    def update_counter(self, cells, updater_id):
        ...
        """
        self.send_update_counter(cells, updater_id)
        self.recv_update_counter()

    def send_update_counter(self, cells, updater_id):
        self._oprot.writeMessageBegin('update_counter', TMessageType.CALL, self._seqid)
    ...
    def update_by_types(self, plain, counter, serial, updater_id):
        ...
        """
        self.send_update_by_types(plain, counter, serial, updater_id)
        self.recv_update_by_types()

    def send_update_by_types(self, plain, counter, serial, updater_id):
        self._oprot.writeMessageBegin('update_by_types', TMessageType.CALL, self._seqid)
...
class Processor(TProcessor):
    ...
    def process_sql_select_plain(self, seqid, iprot, oprot):
        ...
        result = sql_select_plain_result()
        try:
            result.success = self._handler.sql_select_plain(args.sql)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exception as e:
    ...
    def process_sql_select_counter(self, seqid, iprot, oprot):
        ...
        result = sql_select_counter_result()
        try:
            result.success = self._handler.sql_select_counter(args.sql)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exception as e:
    ...
    def process_sql_select_serial(self, seqid, iprot, oprot):
        ...
        result = sql_select_serial_result()
        try:
            result.success = self._handler.sql_select_serial(args.sql)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exception as e:
    ...
    def process_update_plain(self, seqid, iprot, oprot):
        ...
        result = update_plain_result()
        try:
            self._handler.update_plain(args.cells, args.updater_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exception as e:
    ...
    def process_update_counter(self, seqid, iprot, oprot):
        ...
        result = update_counter_result()
        try:
            self._handler.update_counter(args.cells, args.updater_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exception as e:
    ...
    def process_update_by_types(self, seqid, iprot, oprot):
        ...
        result = update_by_types_result()
        try:
            self._handler.update_by_types(args.plain, args.counter, args.serial, args.updater_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exception as e:
...
class sql_select_rslt_on_column_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter473, viter474 in self.success.items():
                oprot.writeString(kiter473)
...
class update_plain_args(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i486 in range(_size482):
                        _key487 = iprot.readI64()
                        _val488 = []
                        (_etype492, _size489) = iprot.readListBegin()
                        for _i493 in range(_size489):
                            _elem494 = UCellPlain()
                            _elem494.read(iprot)
                            _val488.append(_elem494)
                        iprot.readListEnd()
                        self.cells[_key487] = _val488
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.cells is not None:
            ...
            for kiter495, viter496 in self.cells.items():
                oprot.writeI64(kiter495)
                oprot.writeListBegin(TType.STRUCT, len(viter496))
...
class update_counter_args(object):
                ...
                if ftype == TType.MAP:
                    ...
                    for _i502 in range(_size498):
                        ...
                        for _i509 in range(_size505):
                            _elem510 = UCellCounter()
                            _elem510.read(iprot)
                            _val504.append(_elem510)
                        iprot.readListEnd()
                        self.cells[_key503] = _val504
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.cells is not None:
            oprot.writeFieldBegin('cells', TType.MAP, 1)
            oprot.writeMapBegin(TType.I64, TType.LIST, len(self.cells))
            for kiter511, viter512 in self.cells.items():
                oprot.writeI64(kiter511)
                oprot.writeListBegin(TType.STRUCT, len(viter512))
...
class update_serial_args(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i518 in range(_size514):
                        _key519 = iprot.readI64()
                        _val520 = []
                        (_etype524, _size521) = iprot.readListBegin()
                        for _i525 in range(_size521):
                            _elem526 = UCellSerial()
                            _elem526.read(iprot)
                            _val520.append(_elem526)
                        iprot.readListEnd()
                        self.cells[_key519] = _val520
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.cells is not None:
            oprot.writeFieldBegin('cells', TType.MAP, 1)
            oprot.writeMapBegin(TType.I64, TType.LIST, len(self.cells))
            for kiter527, viter528 in self.cells.items():
                oprot.writeI64(kiter527)
                oprot.writeListBegin(TType.STRUCT, len(viter528))
...
class update_by_types_args(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i534 in range(_size530):
                        ...
                        for _i541 in range(_size537):
                            _elem542 = UCellPlain()
                            _elem542.read(iprot)
                            _val536.append(_elem542)
                        iprot.readListEnd()
                        self.plain[_key535] = _val536
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i547 in range(_size543):
                        _key548 = iprot.readI64()
                        _val549 = []
                        (_etype553, _size550) = iprot.readListBegin()
                        for _i554 in range(_size550):
                            _elem555 = UCellCounter()
                            _elem555.read(iprot)
                            _val549.append(_elem555)
                        iprot.readListEnd()
                        self.counter[_key548] = _val549
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i560 in range(_size556):
                        ...
                        for _i567 in range(_size563):
                            _elem568 = UCellSerial()
                            _elem568.read(iprot)
                            _val562.append(_elem568)
                        iprot.readListEnd()
                        self.serial[_key561] = _val562
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.plain is not None:
            ...
            for kiter569, viter570 in self.plain.items():
                oprot.writeI64(kiter569)
                oprot.writeListBegin(TType.STRUCT, len(viter570))
        ...
        if self.counter is not None:
            ...
            for kiter572, viter573 in self.counter.items():
        ...
        if self.serial is not None:
            ...
            for kiter575, viter576 in self.serial.items():
                oprot.writeI64(kiter575)
                oprot.writeListBegin(TType.STRUCT, len(viter576))
                for iter577 in viter576:
                    iter577.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
