...
class Processor(Iface, TProcessor):
    ...
    def process_sql_select_plain(self, seqid, iprot, oprot):
        ...
        msg_type = TMessageType.REPLY
        try:
            result.success = yield gen.maybe_future(self._handler.sql_select_plain(args.sql))
        except Exception as e:
            result.e = e
        except TTransport.TTransportException:
            raise
    ...
    def process_sql_select_counter(self, seqid, iprot, oprot):
        ...
        msg_type = TMessageType.REPLY
        try:
            result.success = yield gen.maybe_future(self._handler.sql_select_counter(args.sql))
        except Exception as e:
            result.e = e
        except TTransport.TTransportException:
            raise
    ...
    def process_sql_select_serial(self, seqid, iprot, oprot):
        ...
        msg_type = TMessageType.REPLY
        try:
            result.success = yield gen.maybe_future(self._handler.sql_select_serial(args.sql))
        except Exception as e:
            result.e = e
        except TTransport.TTransportException:
            raise
    ...
    def process_update_plain(self, seqid, iprot, oprot):
        ...
        msg_type = TMessageType.REPLY
        try:
            yield gen.maybe_future(self._handler.update_plain(args.cells, args.updater_id))
        except Exception as e:
            result.e = e
        except TTransport.TTransportException:
            raise
    ...
    def process_update_counter(self, seqid, iprot, oprot):
        ...
        msg_type = TMessageType.REPLY
        try:
            yield gen.maybe_future(self._handler.update_counter(args.cells, args.updater_id))
        except Exception as e:
            result.e = e
        except TTransport.TTransportException:
            raise
    ...
    def process_update_by_types(self, seqid, iprot, oprot):
        ...
        msg_type = TMessageType.REPLY
        try:
            yield gen.maybe_future(self._handler.update_by_types(args.plain, args.counter, args.serial, args.updater_id))
        except Exception as e:
            result.e = e
        except TTransport.TTransportException:
            raise
