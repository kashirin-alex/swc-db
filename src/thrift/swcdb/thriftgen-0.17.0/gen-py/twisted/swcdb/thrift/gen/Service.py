...
class Client(object):
    ...
    def update_by_types(self, plain, serial, updater_id):
        ...
        d = defer.maybeDeferred(self.send_update_by_types, plain, serial, updater_id)
        d.addCallbacks(
...
class Processor(TProcessor):
    ...
    def process_update_by_types(self, seqid, iprot, oprot):
        ...
        iprot.readMessageEnd()
        result = update_by_types_result()
        d = defer.maybeDeferred(self._handler.update_by_types, args.plain, args.serial, args.updater_id)
