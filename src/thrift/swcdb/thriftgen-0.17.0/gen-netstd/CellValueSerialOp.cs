...
public partial class CellValueSerialOp : TBase
{
  ...
  {
    var tmp302 = new CellValueSerialOp();
    if(__isset.field_id)
    {
      tmp302.Field_id = this.Field_id;
    }
    tmp302.__isset.field_id = this.__isset.field_id;
    if((V_int64 != null) && __isset.v_int64)
    {
      tmp302.V_int64 = (FU_INT64)this.V_int64.DeepCopy();
    }
    tmp302.__isset.v_int64 = this.__isset.v_int64;
    if((V_double != null) && __isset.v_double)
    {
      tmp302.V_double = (FU_DOUBLE)this.V_double.DeepCopy();
    }
    tmp302.__isset.v_double = this.__isset.v_double;
    if((V_bytes != null) && __isset.v_bytes)
    {
      tmp302.V_bytes = (FU_BYTES)this.V_bytes.DeepCopy();
    }
    tmp302.__isset.v_bytes = this.__isset.v_bytes;
    if((V_key != null) && __isset.v_key)
    {
      tmp302.V_key = this.V_key.DeepCopy();
    }
    tmp302.__isset.v_key = this.__isset.v_key;
    if((V_li != null) && __isset.v_li)
    {
      tmp302.V_li = (FU_LI)this.V_li.DeepCopy();
    }
    tmp302.__isset.v_li = this.__isset.v_li;
    if((V_lb != null) && __isset.v_lb)
    {
      tmp302.V_lb = (FU_LB)this.V_lb.DeepCopy();
    }
    tmp302.__isset.v_lb = this.__isset.v_lb;
    return tmp302;
  }
            ...
            {
              {
                ...
                V_key = new List<byte[]>(_list303.Count);
                for(int _i304 = 0; _i304 < _list303.Count; ++_i304)
                {
                  byte[] _elem305;
                  _elem305 = await iprot.ReadBinaryAsync(cancellationToken);
                  V_key.Add(_elem305);
                }
  ...
  public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      ...
      if((V_key != null) && __isset.v_key)
      {
        ...
        foreach (byte[] _iter308 in V_key)
        {
          await oprot.WriteBinaryAsync(_iter308, cancellationToken);
        }
  ...
  {
    var tmp309 = new StringBuilder("CellValueSerialOp(");
    int tmp310 = 0;
    if(__isset.field_id)
    {
      if(0 < tmp310++) { tmp309.Append(", "); }
      tmp309.Append("Field_id: ");
      Field_id.ToString(tmp309);
    }
    if((V_int64 != null) && __isset.v_int64)
    {
      if(0 < tmp310++) { tmp309.Append(", "); }
      tmp309.Append("V_int64: ");
      V_int64.ToString(tmp309);
    }
    if((V_double != null) && __isset.v_double)
    {
      if(0 < tmp310++) { tmp309.Append(", "); }
      tmp309.Append("V_double: ");
      V_double.ToString(tmp309);
    }
    if((V_bytes != null) && __isset.v_bytes)
    {
      if(0 < tmp310++) { tmp309.Append(", "); }
      tmp309.Append("V_bytes: ");
      V_bytes.ToString(tmp309);
    }
    if((V_key != null) && __isset.v_key)
    {
      if(0 < tmp310++) { tmp309.Append(", "); }
      tmp309.Append("V_key: ");
      V_key.ToString(tmp309);
    }
    if((V_li != null) && __isset.v_li)
    {
      if(0 < tmp310++) { tmp309.Append(", "); }
      tmp309.Append("V_li: ");
      V_li.ToString(tmp309);
    }
    if((V_lb != null) && __isset.v_lb)
    {
      if(0 < tmp310++) { tmp309.Append(", "); }
      tmp309.Append("V_lb: ");
      V_lb.ToString(tmp309);
    }
    tmp309.Append(')');
