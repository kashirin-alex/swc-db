...
public partial class CompactResult : TBase
{
  ...
  {
    var tmp489 = new CompactResult();
    if(__isset.cid)
    {
      tmp489.Cid = this.Cid;
    }
    tmp489.__isset.cid = this.__isset.cid;
    if(__isset.err)
    {
      tmp489.Err = this.Err;
    }
    tmp489.__isset.err = this.__isset.err;
    return tmp489;
  }
  ...
  {
    var tmp492 = new StringBuilder("CompactResult(");
    int tmp493 = 0;
    if(__isset.cid)
    {
