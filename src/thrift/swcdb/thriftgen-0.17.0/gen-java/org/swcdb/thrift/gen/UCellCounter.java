    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UCellCounter struct) throws org.apache.thrift.TException {
      ...
      if (struct.k != null) {
        oprot.writeFieldBegin(K_FIELD_DESC);
        {
          ...
          for (java.nio.ByteBuffer _iter283 : struct.k)
          {
      ...
      if (struct.isSetK()) {
        {
          ...
          for (java.nio.ByteBuffer _iter284 : struct.k)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.k = new java.util.ArrayList<java.nio.ByteBuffer>(_list285.size);
