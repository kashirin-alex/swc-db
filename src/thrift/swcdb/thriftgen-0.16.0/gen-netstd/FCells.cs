      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          case 1:
            ...
            {
              {
                TMap _map440 = await iprot.ReadMapBeginAsync(cancellationToken);
          ...
          case 2:
            ...
            {
              {
                TList _list444 = await iprot.ReadListBeginAsync(cancellationToken);
          ...
          case 3:
            ...
            {
              {
                TList _list447 = await iprot.ReadListBeginAsync(cancellationToken);
