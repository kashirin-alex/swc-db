...
struct _swcdb_thriftServiceIfInterface
{
  ...
  gboolean (*update_by_types) (swcdb_thriftServiceIf *iface, const swcdb_thriftUCCells * plain, const swcdb_thriftUCCellsSerial * serial, const gint64 updater_id, swcdb_thriftException ** e, GError **error);
...
gboolean swcdb_thrift_service_if_update_by_types (swcdb_thriftServiceIf *iface, const swcdb_thriftUCCells * plain, const swcdb_thriftUCCellsSerial * serial, const gint64 updater_id, swcdb_thriftException ** e, GError **error);
