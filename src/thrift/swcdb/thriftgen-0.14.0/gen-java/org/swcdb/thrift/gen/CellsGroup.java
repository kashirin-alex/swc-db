...
public class CellsGroup implements org.apache.thrift.TBase<CellsGroup, CellsGroup._Fields>, java.io.Serializable, Cloneable, Comparable<CellsGroup> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.ccells = new java.util.HashMap<java.lang.String,ColCells>(2*_map378.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key379;
                @org.apache.thrift.annotation.Nullable ColCells _val380;
                for (int _i381 = 0; _i381 < _map378.size; ++_i381)
                {
                  _key379 = iprot.readString();
                  _val380 = new ColCells();
                  _val380.read(iprot);
                  struct.ccells.put(_key379, _val380);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.kcells = new java.util.ArrayList<kCells>(_list382.size);
                @org.apache.thrift.annotation.Nullable kCells _elem383;
                for (int _i384 = 0; _i384 < _list382.size; ++_i384)
                {
                  _elem383 = new kCells();
                  _elem383.read(iprot);
                  struct.kcells.add(_elem383);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CellsGroup struct) throws org.apache.thrift.TException {
      ...
      if (struct.ccells != null) {
        oprot.writeFieldBegin(CCELLS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, ColCells> _iter385 : struct.ccells.entrySet())
          {
      ...
      if (struct.kcells != null) {
        oprot.writeFieldBegin(KCELLS_FIELD_DESC);
        {
          ...
          for (kCells _iter386 : struct.kcells)
          {
  ...
  private static class CellsGroupTupleScheme extends org.apache.thrift.scheme.TupleScheme<CellsGroup> {
      ...
      if (struct.isSetCcells()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, ColCells> _iter387 : struct.ccells.entrySet())
          {
            oprot.writeString(_iter387.getKey());
            _iter387.getValue().write(oprot);
          }
        }
      }
      if (struct.isSetKcells()) {
        {
          ...
          for (kCells _iter388 : struct.kcells)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CellsGroup struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map389 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT); 
          struct.ccells = new java.util.HashMap<java.lang.String,ColCells>(2*_map389.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key390;
          @org.apache.thrift.annotation.Nullable ColCells _val391;
          for (int _i392 = 0; _i392 < _map389.size; ++_i392)
          {
            _key390 = iprot.readString();
            _val391 = new ColCells();
            _val391.read(iprot);
            struct.ccells.put(_key390, _val391);
          }
        }
        struct.setCcellsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.kcells = new java.util.ArrayList<kCells>(_list393.size);
          @org.apache.thrift.annotation.Nullable kCells _elem394;
          for (int _i395 = 0; _i395 < _list393.size; ++_i395)
          {
            _elem394 = new kCells();
            _elem394.read(iprot);
            struct.kcells.add(_elem394);
          }
        }
        struct.setKcellsIsSet(true);
      }
