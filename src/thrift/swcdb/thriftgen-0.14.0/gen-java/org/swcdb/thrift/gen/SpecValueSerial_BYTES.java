 ...
 */
public class SpecValueSerial_BYTES implements org.apache.thrift.TBase<SpecValueSerial_BYTES, SpecValueSerial_BYTES._Fields>, java.io.Serializable, Cloneable, Comparable<SpecValueSerial_BYTES> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SpecValueSerial_BYTES");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SpecValueSerial_BYTESStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SpecValueSerial_BYTESTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SpecValueSerial_BYTES.class, metaDataMap);
  }
   ...
   */
  public SpecValueSerial_BYTES(SpecValueSerial_BYTES other) {
    if (other.isSetComp()) {
  ...
  public SpecValueSerial_BYTES deepCopy() {
    return new SpecValueSerial_BYTES(this);
  }
   ...
   * @see Comp
   */
  public SpecValueSerial_BYTES setComp(@org.apache.thrift.annotation.Nullable Comp comp) {
    this.comp = comp;
    return this;
  }
   ...
   * The binary(bytes) to match against the value field
   */
  public SpecValueSerial_BYTES setV(byte[] v) {
    this.v = v == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(v.clone());
    return this;
  }

  public SpecValueSerial_BYTES setV(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer v) {
    this.v = org.apache.thrift.TBaseHelper.copyBinary(v);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof SpecValueSerial_BYTES)
      return this.equals((SpecValueSerial_BYTES)that);
    return false;
  }

  public boolean equals(SpecValueSerial_BYTES that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(SpecValueSerial_BYTES other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SpecValueSerial_BYTES(");
    boolean first = true;
  ...
  private static class SpecValueSerial_BYTESStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SpecValueSerial_BYTESStandardScheme getScheme() {
      return new SpecValueSerial_BYTESStandardScheme();
    }
  }

  private static class SpecValueSerial_BYTESStandardScheme extends org.apache.thrift.scheme.StandardScheme<SpecValueSerial_BYTES> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SpecValueSerial_BYTES struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SpecValueSerial_BYTES struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SpecValueSerial_BYTESTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SpecValueSerial_BYTESTupleScheme getScheme() {
      return new SpecValueSerial_BYTESTupleScheme();
    }
  }

  private static class SpecValueSerial_BYTESTupleScheme extends org.apache.thrift.scheme.TupleScheme<SpecValueSerial_BYTES> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SpecValueSerial_BYTES struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SpecValueSerial_BYTES struct) throws org.apache.thrift.TException {
