    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SpecValueSerial_KEY struct) throws org.apache.thrift.TException {
      ...
      if (struct.v != null) {
        oprot.writeFieldBegin(V_FIELD_DESC);
        {
          ...
          for (SpecFraction _iter91 : struct.v)
          {
            _iter91.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetV()) {
        {
          ...
          for (SpecFraction _iter92 : struct.v)
          {
            _iter92.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.v = new java.util.ArrayList<SpecFraction>(_list93.size);
          @org.apache.thrift.annotation.Nullable SpecFraction _elem94;
          for (int _i95 = 0; _i95 < _list93.size; ++_i95)
          {
            _elem94 = new SpecFraction();
            _elem94.read(iprot);
            struct.v.add(_elem94);
          }
        }
        struct.setVIsSet(true);
      }
