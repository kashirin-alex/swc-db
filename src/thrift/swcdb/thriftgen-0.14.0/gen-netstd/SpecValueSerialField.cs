...
public partial class SpecValueSerialField : TBase
{
  ...
  {
    var tmp94 = new SpecValueSerialField();
    if(__isset.field_id)
    {
      tmp94.Field_id = this.Field_id;
    }
    tmp94.__isset.field_id = this.__isset.field_id;
    if((Spec_int64 != null) && __isset.spec_int64)
    {
      tmp94.Spec_int64 = (SpecValueSerial_INT64)this.Spec_int64.DeepCopy();
    }
    tmp94.__isset.spec_int64 = this.__isset.spec_int64;
    if((Spec_double != null) && __isset.spec_double)
    {
      tmp94.Spec_double = (SpecValueSerial_DOUBLE)this.Spec_double.DeepCopy();
    }
    tmp94.__isset.spec_double = this.__isset.spec_double;
    if((Spec_bytes != null) && __isset.spec_bytes)
    {
      tmp94.Spec_bytes = (SpecValueSerial_BYTES)this.Spec_bytes.DeepCopy();
    }
    tmp94.__isset.spec_bytes = this.__isset.spec_bytes;
    if((Spec_key != null) && __isset.spec_key)
    {
      tmp94.Spec_key = (SpecValueSerial_KEY)this.Spec_key.DeepCopy();
    }
    tmp94.__isset.spec_key = this.__isset.spec_key;
    if((Spec_li != null) && __isset.spec_li)
    {
      tmp94.Spec_li = (SpecValueSerial_LI)this.Spec_li.DeepCopy();
    }
    tmp94.__isset.spec_li = this.__isset.spec_li;
    if((Spec_lb != null) && __isset.spec_lb)
    {
      tmp94.Spec_lb = (SpecValueSerial_LB)this.Spec_lb.DeepCopy();
    }
    tmp94.__isset.spec_lb = this.__isset.spec_lb;
    return tmp94;
  }
