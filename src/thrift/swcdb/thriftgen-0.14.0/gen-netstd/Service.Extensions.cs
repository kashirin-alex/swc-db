...
public static class ServiceExtensions
{
  ...
  public static Dictionary<byte[], FCells> DeepCopy(this Dictionary<byte[], FCells> source)
  {
    ...
    var tmp438 = new Dictionary<byte[], FCells>(source.Count);
    foreach (var pair in source)
      tmp438.Add((pair.Key != null) ? pair.Key.ToArray() : null, (pair.Value != null) ? pair.Value.DeepCopy() : null);
    return tmp438;
  }
  ...
  public static Dictionary<long, List<UCell>> DeepCopy(this Dictionary<long, List<UCell>> source)
  {
    ...
    var tmp439 = new Dictionary<long, List<UCell>>(source.Count);
    foreach (var pair in source)
      tmp439.Add(pair.Key, (pair.Value != null) ? pair.Value.DeepCopy() : null);
    return tmp439;
  }
  ...
  public static Dictionary<long, List<UCellSerial>> DeepCopy(this Dictionary<long, List<UCellSerial>> source)
  {
    ...
    var tmp440 = new Dictionary<long, List<UCellSerial>>(source.Count);
    foreach (var pair in source)
      tmp440.Add(pair.Key, (pair.Value != null) ? pair.Value.DeepCopy() : null);
    return tmp440;
  }
  ...
  public static Dictionary<string, ColCells> DeepCopy(this Dictionary<string, ColCells> source)
  {
    ...
    var tmp441 = new Dictionary<string, ColCells>(source.Count);
    foreach (var pair in source)
      tmp441.Add((pair.Key != null) ? pair.Key : null, (pair.Value != null) ? pair.Value.DeepCopy() : null);
    return tmp441;
  }
  ...
  public static List<CCell> DeepCopy(this List<CCell> source)
  {
    ...
    var tmp442 = new List<CCell>(source.Count);
  ...
  public static List<CCellSerial> DeepCopy(this List<CCellSerial> source)
  {
    ...
    var tmp443 = new List<CCellSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<Cell> DeepCopy(this List<Cell> source)
  {
    ...
    var tmp444 = new List<Cell>(source.Count);
    foreach (var elem in source)
  ...
  public static List<CellSerial> DeepCopy(this List<CellSerial> source)
  {
    ...
    var tmp445 = new List<CellSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<CellValueSerial> DeepCopy(this List<CellValueSerial> source)
  {
    ...
    var tmp446 = new List<CellValueSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<CompactResult> DeepCopy(this List<CompactResult> source)
  {
    ...
    var tmp447 = new List<CompactResult>(source.Count);
    foreach (var elem in source)
  ...
  public static List<FCell> DeepCopy(this List<FCell> source)
  {
    ...
    var tmp448 = new List<FCell>(source.Count);
    foreach (var elem in source)
  ...
  public static List<FCellSerial> DeepCopy(this List<FCellSerial> source)
  {
    ...
    var tmp449 = new List<FCellSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<KCell> DeepCopy(this List<KCell> source)
  {
    ...
    var tmp450 = new List<KCell>(source.Count);
    foreach (var elem in source)
  ...
  public static List<KCellSerial> DeepCopy(this List<KCellSerial> source)
  {
    ...
    var tmp451 = new List<KCellSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<Schema> DeepCopy(this List<Schema> source)
  {
    ...
    var tmp452 = new List<Schema>(source.Count);
    foreach (var elem in source)
  ...
  public static List<SchemaPattern> DeepCopy(this List<SchemaPattern> source)
  {
    ...
    var tmp453 = new List<SchemaPattern>(source.Count);
    foreach (var elem in source)
  ...
  public static List<SpecColumn> DeepCopy(this List<SpecColumn> source)
  {
    ...
    var tmp454 = new List<SpecColumn>(source.Count);
    foreach (var elem in source)
  ...
  public static List<SpecColumnSerial> DeepCopy(this List<SpecColumnSerial> source)
  {
    ...
    var tmp455 = new List<SpecColumnSerial>(source.Count);
    foreach (var elem in source)
      tmp455.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp455;
  }
  ...
  public static List<SpecFraction> DeepCopy(this List<SpecFraction> source)
  {
    ...
    var tmp456 = new List<SpecFraction>(source.Count);
    foreach (var elem in source)
  ...
  public static List<SpecInterval> DeepCopy(this List<SpecInterval> source)
  {
    ...
    var tmp457 = new List<SpecInterval>(source.Count);
    foreach (var elem in source)
      tmp457.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp457;
  }
  ...
  public static List<SpecIntervalSerial> DeepCopy(this List<SpecIntervalSerial> source)
  {
    ...
    var tmp458 = new List<SpecIntervalSerial>(source.Count);
    foreach (var elem in source)
      tmp458.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp458;
  }
  ...
  public static List<SpecKeyInterval> DeepCopy(this List<SpecKeyInterval> source)
  {
    ...
    var tmp459 = new List<SpecKeyInterval>(source.Count);
    foreach (var elem in source)
      tmp459.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp459;
  }
  ...
  public static List<SpecValue> DeepCopy(this List<SpecValue> source)
  {
    ...
    var tmp460 = new List<SpecValue>(source.Count);
    foreach (var elem in source)
      tmp460.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp460;
  }
  ...
  public static List<SpecValueSerial> DeepCopy(this List<SpecValueSerial> source)
  {
    ...
    var tmp461 = new List<SpecValueSerial>(source.Count);
    foreach (var elem in source)
      tmp461.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp461;
  }
  ...
  public static List<SpecValueSerialField> DeepCopy(this List<SpecValueSerialField> source)
  {
    ...
    var tmp462 = new List<SpecValueSerialField>(source.Count);
    foreach (var elem in source)
      tmp462.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp462;
  }
  ...
  public static List<SpecValueSerial_BYTES> DeepCopy(this List<SpecValueSerial_BYTES> source)
  {
    ...
    var tmp463 = new List<SpecValueSerial_BYTES>(source.Count);
    foreach (var elem in source)
      tmp463.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp463;
  }
  ...
  public static List<SpecValueSerial_INT64> DeepCopy(this List<SpecValueSerial_INT64> source)
  {
    ...
    var tmp464 = new List<SpecValueSerial_INT64>(source.Count);
    foreach (var elem in source)
      tmp464.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp464;
  }
  ...
  public static List<UCell> DeepCopy(this List<UCell> source)
  {
    ...
    var tmp465 = new List<UCell>(source.Count);
    foreach (var elem in source)
      tmp465.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp465;
  }
  ...
  public static List<UCellSerial> DeepCopy(this List<UCellSerial> source)
  {
    ...
    var tmp466 = new List<UCellSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<byte[]> DeepCopy(this List<byte[]> source)
  {
    ...
    var tmp467 = new List<byte[]>(source.Count);
    foreach (var elem in source)
      tmp467.Add((elem != null) ? elem.ToArray() : null);
    return tmp467;
  }
  ...
  public static List<kCells> DeepCopy(this List<kCells> source)
  {
    ...
    var tmp468 = new List<kCells>(source.Count);
    foreach (var elem in source)
  ...
  public static List<long> DeepCopy(this List<long> source)
  {
    ...
    var tmp469 = new List<long>(source.Count);
    foreach (var elem in source)
      tmp469.Add(elem);
    return tmp469;
  }
  ...
  public static List<string> DeepCopy(this List<string> source)
  {
    ...
    var tmp470 = new List<string>(source.Count);
    foreach (var elem in source)
      tmp470.Add((elem != null) ? elem : null);
    return tmp470;
  }
