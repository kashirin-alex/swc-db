...
public partial class CellSerial : TBase
{
  ...
  {
    var tmp180 = new CellSerial();
    if((C != null) && __isset.c)
    {
      tmp180.C = this.C;
    }
    tmp180.__isset.c = this.__isset.c;
    if((K != null) && __isset.k)
    {
      tmp180.K = this.K.DeepCopy();
    }
    tmp180.__isset.k = this.__isset.k;
    if(__isset.ts)
    {
      tmp180.Ts = this.Ts;
    }
    tmp180.__isset.ts = this.__isset.ts;
    if((V != null) && __isset.v)
    {
      tmp180.V = this.V.DeepCopy();
    }
    tmp180.__isset.v = this.__isset.v;
    return tmp180;
  }
            ...
            {
              {
                ...
                K = new List<byte[]>(_list181.Count);
            ...
            {
              {
                ...
                V = new List<CellValueSerial>(_list184.Count);
                for(int _i185 = 0; _i185 < _list184.Count; ++_i185)
                {
                  CellValueSerial _elem186;
                  _elem186 = new CellValueSerial();
    ...
    try
    {
      ...
      if((V != null) && __isset.v)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (CellValueSerial _iter188 in V)
          {
