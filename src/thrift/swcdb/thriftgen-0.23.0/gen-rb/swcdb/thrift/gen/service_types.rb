      ...
      class Schema
        ...
        def validate
          unless @col_seq.nil? || ::Swcdb::Thrift::Gen::KeySeq::VALID_VALUES.include?(@col_seq)
            raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field col_seq!')
          end
          unless @col_type.nil? || ::Swcdb::Thrift::Gen::ColumnType::VALID_VALUES.include?(@col_type)
            raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field col_type!')
          end
          unless @blk_encoding.nil? || ::Swcdb::Thrift::Gen::EncodingType::VALID_VALUES.include?(@blk_encoding)
            raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field blk_encoding!')
          end
        end
      ...
      class SchemaPattern
        ...
        def validate
          unless @comp.nil? || ::Swcdb::Thrift::Gen::Comp::VALID_VALUES.include?(@comp)
            raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field comp!')
          end
        end
      ...
      class SpecUpdateOP
        ...
        def validate
          unless @op.nil? || ::Swcdb::Thrift::Gen::UpdateOP::VALID_VALUES.include?(@op)
            raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field op!')
          end
        end
      ...
      class SpecIntervalUpdatePlain
        ...
        def validate
          unless @encoder.nil? || ::Swcdb::Thrift::Gen::EncodingType::VALID_VALUES.include?(@encoder)
            raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field encoder!')
          end
        end
      ...
      class SpecValueSerial_KEY
        ...
        def validate
          unless @seq.nil? || ::Swcdb::Thrift::Gen::KeySeq::VALID_VALUES.include?(@seq)
            raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field seq!')
          end
        end
      ...
      class SpecIntervalPlain
        ...
        def validate
          unless @options.nil? || ::Swcdb::Thrift::Gen::SpecIntervalOptions::VALID_VALUES.include?(@options)
            raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field options!')
          end
        end
      ...
      class UCellPlain
        ...
        def validate
          unless @f.nil? || ::Swcdb::Thrift::Gen::Flag::VALID_VALUES.include?(@f)
            raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field f!')
          end
          unless @encoder.nil? || ::Swcdb::Thrift::Gen::EncodingType::VALID_VALUES.include?(@encoder)
            raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field encoder!')
          end
