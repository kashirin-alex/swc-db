      ...
      module Service
        class Client
          ...
          def recv_sql_mng_column()
            ...
            validate_message_begin(fname, mtype, rseqid, 'sql_mng_column')
          ...
          def recv_sql_list_columns()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_list_columns')
          ...
          def recv_sql_compact_columns()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_compact_columns')
          ...
          def recv_sql_select_plain()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_select_plain')
          ...
          def recv_sql_select_counter()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_select_counter')
          ...
          def recv_sql_select_serial()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_select_serial')
          ...
          def recv_sql_select()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_select')
          ...
          def recv_sql_select_rslt_on_column()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_select_rslt_on_column')
          ...
          def recv_sql_select_rslt_on_key()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_select_rslt_on_key')
          ...
          def recv_sql_select_rslt_on_fraction()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_select_rslt_on_fraction')
          ...
          def recv_sql_query()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_query')
          ...
          def recv_sql_update()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'sql_update')
          ...
          def recv_exec_sql()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'exec_sql')
          ...
          def recv_updater_create()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'updater_create')
          ...
          def recv_updater_close()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'updater_close')
          ...
          def recv_update_plain()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'update_plain')
          ...
          def recv_update_counter()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'update_counter')
          ...
          def recv_update_serial()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'update_serial')
          ...
          def recv_update_by_types()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'update_by_types')
          ...
          def recv_mng_column()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'mng_column')
          ...
          def recv_list_columns()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'list_columns')
          ...
          def recv_compact_columns()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'compact_columns')
          ...
          def recv_scan()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'scan')
          ...
          def recv_scan_rslt_on_column()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'scan_rslt_on_column')
          ...
          def recv_scan_rslt_on_key()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'scan_rslt_on_key')
          ...
          def recv_scan_rslt_on_fraction()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'scan_rslt_on_fraction')
          ...
          def recv_scan_rslt_on()
            fname, mtype, rseqid = receive_message_begin()
            validate_message_begin(fname, mtype, rseqid, 'scan_rslt_on')
        ...
        class Sql_query_args
          ...
          def validate
            unless @rslt.nil? || ::Swcdb::Thrift::Gen::CellsResult::VALID_VALUES.include?(@rslt)
              raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field rslt!')
            end
          end
        ...
        class Mng_column_args
          ...
          def validate
            unless @func.nil? || ::Swcdb::Thrift::Gen::SchemaFunc::VALID_VALUES.include?(@func)
              raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::INVALID_DATA, 'Invalid value of field func!')
            end
          end
