...
func KeySeqValues() iter.Seq[KeySeq] {
	return func(yield func(KeySeq) bool) {
		for _, v := range knownKeySeqValues {
			if !yield(v) {
				return
			}
		}
...
var knownColumnTypeValues = []ColumnType{
	ColumnType_UNKNOWN,
	ColumnType_PLAIN,
	ColumnType_COUNTER_I64,
	ColumnType_COUNTER_I32,
	ColumnType_COUNTER_I16,
	ColumnType_COUNTER_I8,
	ColumnType_SERIAL,
	ColumnType_CELL_DEFINED,
}

func ColumnTypeValues() iter.Seq[ColumnType] {
	return func(yield func(ColumnType) bool) {
		for _, v := range knownColumnTypeValues {
			if !yield(v) {
				return
			}
		}
...
var knownEncodingTypeValues = []EncodingType{
	EncodingType_DEFAULT,
	EncodingType_PLAIN,
	EncodingType_ZLIB,
	EncodingType_SNAPPY,
	EncodingType_ZSTD,
...
func EncodingTypeValues() iter.Seq[EncodingType] {
	return func(yield func(EncodingType) bool) {
		for _, v := range knownEncodingTypeValues {
			if !yield(v) {
				return
			}
		}
...
var knownSchemaFuncValues = []SchemaFunc{
	SchemaFunc_CREATE,
	SchemaFunc_REMOVE,
	SchemaFunc_MODIFY,
}

func SchemaFuncValues() iter.Seq[SchemaFunc] {
	return func(yield func(SchemaFunc) bool) {
		for _, v := range knownSchemaFuncValues {
			if !yield(v) {
				return
			}
		}
...
func CompValues() iter.Seq[Comp] {
	return func(yield func(Comp) bool) {
		for _, v := range knownCompValues {
			if !yield(v) {
				return
			}
		}
...
var knownSpecFlagsOptValues = []SpecFlagsOpt{
	SpecFlagsOpt_NONE,
	SpecFlagsOpt_LIMIT_BY_KEYS,
	SpecFlagsOpt_OFFSET_BY_KEYS,
	SpecFlagsOpt_ONLY_KEYS,
	SpecFlagsOpt_ONLY_DELETES,
}

func SpecFlagsOptValues() iter.Seq[SpecFlagsOpt] {
	return func(yield func(SpecFlagsOpt) bool) {
		for _, v := range knownSpecFlagsOptValues {
			if !yield(v) {
				return
			}
		}
...
var knownUpdateOPValues = []UpdateOP{
	UpdateOP_REPLACE,
	UpdateOP_APPEND,
	UpdateOP_PREPEND,
	UpdateOP_INSERT,
...
func UpdateOPValues() iter.Seq[UpdateOP] {
	return func(yield func(UpdateOP) bool) {
		for _, v := range knownUpdateOPValues {
			if !yield(v) {
				return
			}
		}
...
var knownSpecIntervalOptionsValues = []SpecIntervalOptions{
	SpecIntervalOptions_UPDATING,
	SpecIntervalOptions_DELETING,
}

func SpecIntervalOptionsValues() iter.Seq[SpecIntervalOptions] {
	return func(yield func(SpecIntervalOptions) bool) {
		for _, v := range knownSpecIntervalOptionsValues {
			if !yield(v) {
				return
			}
		}
...
func FlagValues() iter.Seq[Flag] {
	return func(yield func(Flag) bool) {
		for _, v := range knownFlagValues {
			if !yield(v) {
				return
			}
		}
...
var knownFU_MATH_OPValues = []FU_MATH_OP{
	FU_MATH_OP_EQUAL,
	FU_MATH_OP_PLUS,
	FU_MATH_OP_MULTIPLY,
	FU_MATH_OP_DIVIDE,
...
func FU_MATH_OPValues() iter.Seq[FU_MATH_OP] {
	return func(yield func(FU_MATH_OP) bool) {
		for _, v := range knownFU_MATH_OPValues {
			if !yield(v) {
				return
			}
		}
...
var knownFU_LIST_OPValues = []FU_LIST_OP{
	FU_LIST_OP_REPLACE,
	FU_LIST_OP_APPEND,
	FU_LIST_OP_PREPEND,
	FU_LIST_OP_INSERT,
	FU_LIST_OP_OVERWRITE,
	FU_LIST_OP_ERASE,
	FU_LIST_OP_BY_UNIQUE,
	FU_LIST_OP_BY_COND,
	FU_LIST_OP_BY_INDEX,
}

func FU_LIST_OPValues() iter.Seq[FU_LIST_OP] {
	return func(yield func(FU_LIST_OP) bool) {
		for _, v := range knownFU_LIST_OPValues {
			if !yield(v) {
				return
			}
		}
...
var knownCellsResult_Values = []CellsResult_{
	CellsResult__IN_LIST,
	CellsResult__ON_COLUMN,
	CellsResult__ON_KEY,
	CellsResult__ON_FRACTION,
}

func CellsResult_Values() iter.Seq[CellsResult_] {
	return func(yield func(CellsResult_) bool) {
		for _, v := range knownCellsResult_Values {
			if !yield(v) {
				return
			}
		}
...
func (p *serviceProcessorSqlMngColumn) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err236 thrift.TException
...
func (p *serviceProcessorSqlListColumns) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err238 thrift.TException
...
func (p *serviceProcessorSqlCompactColumns) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err240 thrift.TException
...
func (p *serviceProcessorSqlSelectPlain) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err242 thrift.TException
...
func (p *serviceProcessorSqlSelectCounter) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err244 thrift.TException
...
func (p *serviceProcessorSqlSelectSerial) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err246 thrift.TException
...
func (p *serviceProcessorSqlSelect) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err248 thrift.TException
...
func (p *serviceProcessorSqlSelectRsltOnColumn) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err250 thrift.TException
...
func (p *serviceProcessorSqlSelectRsltOnKey) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err252 thrift.TException
...
func (p *serviceProcessorSqlSelectRsltOnFraction) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err254 thrift.TException
...
func (p *serviceProcessorSqlQuery) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err256 thrift.TException
...
func (p *serviceProcessorSqlUpdate) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err258 thrift.TException
...
func (p *serviceProcessorExecSql) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err260 thrift.TException
...
func (p *serviceProcessorUpdatePlain) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err266 thrift.TException
...
func (p *serviceProcessorUpdateCounter) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err268 thrift.TException
...
func (p *serviceProcessorUpdateSerial) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err270 thrift.TException
...
func (p *serviceProcessorUpdateByTypes) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err272 thrift.TException
...
func (p *serviceProcessorCompactColumns) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err278 thrift.TException
...
func (p *serviceProcessorScan) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err280 thrift.TException
...
func (p *serviceProcessorScanRsltOnColumn) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err282 thrift.TException
...
func (p *serviceProcessorScanRsltOnKey) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err284 thrift.TException
...
func (p *serviceProcessorScanRsltOnFraction) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err286 thrift.TException
...
func (p *serviceProcessorScanRsltOn) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	var _write_err288 thrift.TException
