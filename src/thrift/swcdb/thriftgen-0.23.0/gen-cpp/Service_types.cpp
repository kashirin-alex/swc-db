...
void swap(Exception &a, Exception &b) noexcept {
  using ::std::swap;
  swap(a.code, b.code);
...
void swap(SchemaPattern &a, SchemaPattern &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
...
bool SchemaPattern::operator==(const SchemaPattern & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
  if (!(value == rhs.value))
...
void swap(SchemaTagsPatterns &a, SchemaTagsPatterns &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
...
bool SchemaTagsPatterns::operator==(const SchemaTagsPatterns & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
...
void swap(SchemaPatterns &a, SchemaPatterns &b) noexcept {
  using ::std::swap;
...
bool SchemaPatterns::operator==(const SchemaPatterns & rhs) const
{
  if (!(names == rhs.names))
    return false;
  if (!(tags == rhs.tags))
...
void swap(SpecSchemas &a, SpecSchemas &b) noexcept {
  using ::std::swap;
  swap(a.cids, b.cids);
  swap(a.names, b.names);
...
bool SpecSchemas::operator==(const SpecSchemas & rhs) const
{
  if (!(cids == rhs.cids))
    return false;
  if (!(names == rhs.names))
...
void swap(SpecFlags &a, SpecFlags &b) noexcept {
  using ::std::swap;
...
bool SpecFlags::operator==(const SpecFlags & rhs) const
{
...
void swap(SpecUpdateOP &a, SpecUpdateOP &b) noexcept {
  using ::std::swap;
  swap(a.op, b.op);
  swap(a.pos, b.pos);
  swap(a.__isset, b.__isset);
...
bool SpecUpdateOP::operator==(const SpecUpdateOP & rhs) const
{
  if (!(op == rhs.op))
    return false;
...
void swap(SpecIntervalUpdatePlain &a, SpecIntervalUpdatePlain &b) noexcept {
  using ::std::swap;
  swap(a.v, b.v);
  swap(a.ts, b.ts);
...
bool SpecIntervalUpdatePlain::operator==(const SpecIntervalUpdatePlain & rhs) const
{
  if (!(v == rhs.v))
    return false;
...
void swap(SpecIntervalUpdateCounter &a, SpecIntervalUpdateCounter &b) noexcept {
  using ::std::swap;
  swap(a.v, b.v);
  swap(a.op, b.op);
  swap(a.ts, b.ts);
...
bool SpecIntervalUpdateCounter::operator==(const SpecIntervalUpdateCounter & rhs) const
{
  if (!(v == rhs.v))
    return false;
  if (!(op == rhs.op))
...
void swap(SpecIntervalUpdateSerial &a, SpecIntervalUpdateSerial &b) noexcept {
  using ::std::swap;
  swap(a.ts, b.ts);
  swap(a.v, b.v);
  swap(a.v_op, b.v_op);
...
bool SpecIntervalUpdateSerial::operator==(const SpecIntervalUpdateSerial & rhs) const
{
  if (!(ts == rhs.ts))
    return false;
  if (!(v == rhs.v))
...
void swap(SpecValueSerial_INT64 &a, SpecValueSerial_INT64 &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
  swap(a.v, b.v);
  swap(a.__isset, b.__isset);
...
bool SpecValueSerial_INT64::operator==(const SpecValueSerial_INT64 & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
  if (!(v == rhs.v))
...
void swap(SpecValueSerial_DOUBLE &a, SpecValueSerial_DOUBLE &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
  swap(a.v, b.v);
  swap(a.__isset, b.__isset);
...
bool SpecValueSerial_DOUBLE::operator==(const SpecValueSerial_DOUBLE & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
  if (!(v == rhs.v))
...
void swap(SpecValueSerial_BYTES &a, SpecValueSerial_BYTES &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
  swap(a.v, b.v);
  swap(a.__isset, b.__isset);
...
bool SpecValueSerial_BYTES::operator==(const SpecValueSerial_BYTES & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
  if (!(v == rhs.v))
...
void swap(SpecValueSerial_KEY &a, SpecValueSerial_KEY &b) noexcept {
  using ::std::swap;
  swap(a.seq, b.seq);
  swap(a.v, b.v);
  swap(a.__isset, b.__isset);
...
bool SpecValueSerial_KEY::operator==(const SpecValueSerial_KEY & rhs) const
{
  if (!(seq == rhs.seq))
    return false;
  if (!(v == rhs.v))
...
void swap(SpecValueSerial_LI &a, SpecValueSerial_LI &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
  swap(a.v, b.v);
  swap(a.__isset, b.__isset);
...
bool SpecValueSerial_LI::operator==(const SpecValueSerial_LI & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
  if (!(v == rhs.v))
...
void swap(SpecValueSerial_LB &a, SpecValueSerial_LB &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
  swap(a.v, b.v);
  swap(a.__isset, b.__isset);
...
bool SpecValueSerial_LB::operator==(const SpecValueSerial_LB & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
  if (!(v == rhs.v))
...
void swap(SpecValueSerialField &a, SpecValueSerialField &b) noexcept {
  using ::std::swap;
...
bool SpecValueSerialField::operator==(const SpecValueSerialField & rhs) const
{
...
void swap(SpecValuePlain &a, SpecValuePlain &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
  swap(a.v, b.v);
  swap(a.__isset, b.__isset);
...
bool SpecValuePlain::operator==(const SpecValuePlain & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
  if (!(v == rhs.v))
...
void swap(SpecValueCounter &a, SpecValueCounter &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
  swap(a.v, b.v);
  swap(a.__isset, b.__isset);
...
bool SpecValueCounter::operator==(const SpecValueCounter & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
  if (!(v == rhs.v))
...
void swap(SpecValueSerial &a, SpecValueSerial &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
...
bool SpecValueSerial::operator==(const SpecValueSerial & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
...
void swap(SpecFraction &a, SpecFraction &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
  swap(a.f, b.f);
  swap(a.__isset, b.__isset);
...
bool SpecFraction::operator==(const SpecFraction & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
  if (!(f == rhs.f))
...
void swap(SpecTimestamp &a, SpecTimestamp &b) noexcept {
  using ::std::swap;
  swap(a.comp, b.comp);
  swap(a.ts, b.ts);
  swap(a.__isset, b.__isset);
...
bool SpecTimestamp::operator==(const SpecTimestamp & rhs) const
{
  if (!(comp == rhs.comp))
    return false;
  if (!(ts == rhs.ts))
...
void swap(SpecKeyInterval &a, SpecKeyInterval &b) noexcept {
  using ::std::swap;
...
bool SpecKeyInterval::operator==(const SpecKeyInterval & rhs) const
{
  if (!(start == rhs.start))
    return false;
...
void swap(SpecIntervalPlain &a, SpecIntervalPlain &b) noexcept {
  using ::std::swap;
...
bool SpecIntervalPlain::operator==(const SpecIntervalPlain & rhs) const
{
...
void swap(SpecIntervalCounter &a, SpecIntervalCounter &b) noexcept {
  using ::std::swap;
  swap(a.range_begin, b.range_begin);
  swap(a.range_end, b.range_end);
  swap(a.offset_key, b.offset_key);
...
bool SpecIntervalCounter::operator==(const SpecIntervalCounter & rhs) const
{
  if (!(range_begin == rhs.range_begin))
    return false;
  if (!(range_end == rhs.range_end))
...
void swap(SpecIntervalSerial &a, SpecIntervalSerial &b) noexcept {
  using ::std::swap;
  swap(a.range_begin, b.range_begin);
  swap(a.range_end, b.range_end);
  swap(a.offset_key, b.offset_key);
...
bool SpecIntervalSerial::operator==(const SpecIntervalSerial & rhs) const
{
  if (!(range_begin == rhs.range_begin))
    return false;
  if (!(range_end == rhs.range_end))
...
void swap(SpecColumnPlain &a, SpecColumnPlain &b) noexcept {
  using ::std::swap;
  swap(a.cid, b.cid);
...
bool SpecColumnPlain::operator==(const SpecColumnPlain & rhs) const
{
  if (!(cid == rhs.cid))
    return false;
...
void swap(SpecColumnCounter &a, SpecColumnCounter &b) noexcept {
  using ::std::swap;
  swap(a.cid, b.cid);
  swap(a.intervals, b.intervals);
  swap(a.__isset, b.__isset);
...
bool SpecColumnCounter::operator==(const SpecColumnCounter & rhs) const
{
  if (!(cid == rhs.cid))
    return false;
  if (!(intervals == rhs.intervals))
...
void swap(SpecColumnSerial &a, SpecColumnSerial &b) noexcept {
  using ::std::swap;
  swap(a.cid, b.cid);
  swap(a.intervals, b.intervals);
  swap(a.__isset, b.__isset);
...
bool SpecColumnSerial::operator==(const SpecColumnSerial & rhs) const
{
  if (!(cid == rhs.cid))
    return false;
  if (!(intervals == rhs.intervals))
...
void swap(SpecScan &a, SpecScan &b) noexcept {
  using ::std::swap;
...
bool SpecScan::operator==(const SpecScan & rhs) const
{
...
void swap(UCellPlain &a, UCellPlain &b) noexcept {
  using ::std::swap;
  swap(a.f, b.f);
  swap(a.k, b.k);
  swap(a.ts, b.ts);
...
bool UCellPlain::operator==(const UCellPlain & rhs) const
{
  if (!(f == rhs.f))
    return false;
  if (!(k == rhs.k))
...
void swap(UCellCounter &a, UCellCounter &b) noexcept {
  using ::std::swap;
  swap(a.f, b.f);
  swap(a.k, b.k);
  swap(a.ts, b.ts);
...
bool UCellCounter::operator==(const UCellCounter & rhs) const
{
  if (!(f == rhs.f))
    return false;
  if (!(k == rhs.k))
...
void swap(CellValueSerial &a, CellValueSerial &b) noexcept {
  using ::std::swap;
  swap(a.field_id, b.field_id);
...
bool CellValueSerial::operator==(const CellValueSerial & rhs) const
{
  if (!(field_id == rhs.field_id))
    return false;
...
void swap(FU_INT64 &a, FU_INT64 &b) noexcept {
  using ::std::swap;
  swap(a.ctrl, b.ctrl);
  swap(a.op, b.op);
  swap(a.pos, b.pos);
...
bool FU_INT64::operator==(const FU_INT64 & rhs) const
{
  if (!(ctrl == rhs.ctrl))
    return false;
  if (!(op == rhs.op))
...
void swap(FU_DOUBLE &a, FU_DOUBLE &b) noexcept {
  using ::std::swap;
  swap(a.ctrl, b.ctrl);
  swap(a.op, b.op);
  swap(a.pos, b.pos);
...
bool FU_DOUBLE::operator==(const FU_DOUBLE & rhs) const
{
  if (!(ctrl == rhs.ctrl))
    return false;
  if (!(op == rhs.op))
...
void swap(FU_BYTES &a, FU_BYTES &b) noexcept {
  using ::std::swap;
  swap(a.ctrl, b.ctrl);
  swap(a.op, b.op);
  swap(a.pos, b.pos);
...
bool FU_BYTES::operator==(const FU_BYTES & rhs) const
{
  if (!(ctrl == rhs.ctrl))
    return false;
  if (!(op == rhs.op))
...
void swap(FU_LI &a, FU_LI &b) noexcept {
  using ::std::swap;
  swap(a.ctrl, b.ctrl);
  swap(a.op, b.op);
  swap(a.pos, b.pos);
...
bool FU_LI::operator==(const FU_LI & rhs) const
{
  if (!(ctrl == rhs.ctrl))
    return false;
  if (!(op == rhs.op))
...
void swap(FU_LB &a, FU_LB &b) noexcept {
  using ::std::swap;
  swap(a.ctrl, b.ctrl);
  swap(a.op, b.op);
  swap(a.pos, b.pos);
...
bool FU_LB::operator==(const FU_LB & rhs) const
{
  if (!(ctrl == rhs.ctrl))
    return false;
  if (!(op == rhs.op))
...
void swap(CellValueSerialOp &a, CellValueSerialOp &b) noexcept {
  using ::std::swap;
  swap(a.field_id, b.field_id);
  swap(a.v_int64, b.v_int64);
  swap(a.v_double, b.v_double);
...
bool CellValueSerialOp::operator==(const CellValueSerialOp & rhs) const
{
  if (!(field_id == rhs.field_id))
    return false;
  if (__isset.v_int64 != rhs.__isset.v_int64)
...
void swap(UCellSerial &a, UCellSerial &b) noexcept {
  using ::std::swap;
  swap(a.f, b.f);
  swap(a.k, b.k);
  swap(a.ts, b.ts);
...
bool UCellSerial::operator==(const UCellSerial & rhs) const
{
  if (!(f == rhs.f))
    return false;
  if (!(k == rhs.k))
...
void swap(CellPlain &a, CellPlain &b) noexcept {
  using ::std::swap;
  swap(a.c, b.c);
  swap(a.k, b.k);
  swap(a.ts, b.ts);
...
bool CellPlain::operator==(const CellPlain & rhs) const
{
  if (!(c == rhs.c))
    return false;
  if (!(k == rhs.k))
...
void swap(CellCounter &a, CellCounter &b) noexcept {
  using ::std::swap;
  swap(a.c, b.c);
  swap(a.k, b.k);
  swap(a.ts, b.ts);
...
bool CellCounter::operator==(const CellCounter & rhs) const
{
  if (!(c == rhs.c))
    return false;
  if (!(k == rhs.k))
...
void swap(CellSerial &a, CellSerial &b) noexcept {
  using ::std::swap;
  swap(a.c, b.c);
  swap(a.k, b.k);
  swap(a.ts, b.ts);
...
bool CellSerial::operator==(const CellSerial & rhs) const
{
  if (!(c == rhs.c))
    return false;
  if (!(k == rhs.k))
...
void swap(Cells &a, Cells &b) noexcept {
  using ::std::swap;
...
void swap(CCellPlain &a, CCellPlain &b) noexcept {
  using ::std::swap;
  swap(a.k, b.k);
  swap(a.ts, b.ts);
  swap(a.v, b.v);
...
bool CCellPlain::operator==(const CCellPlain & rhs) const
{
  if (!(k == rhs.k))
    return false;
  if (!(ts == rhs.ts))
...
void swap(CCellCounter &a, CCellCounter &b) noexcept {
  using ::std::swap;
  swap(a.k, b.k);
  swap(a.ts, b.ts);
  swap(a.v, b.v);
...
bool CCellCounter::operator==(const CCellCounter & rhs) const
{
  if (!(k == rhs.k))
    return false;
  if (!(ts == rhs.ts))
...
void swap(CCellSerial &a, CCellSerial &b) noexcept {
  using ::std::swap;
  swap(a.k, b.k);
  swap(a.ts, b.ts);
  swap(a.v, b.v);
...
bool CCellSerial::operator==(const CCellSerial & rhs) const
{
  if (!(k == rhs.k))
    return false;
  if (!(ts == rhs.ts))
...
void swap(cCells &a, cCells &b) noexcept {
  using ::std::swap;
  swap(a.plain_cells, b.plain_cells);
  swap(a.counter_cells, b.counter_cells);
  swap(a.serial_cells, b.serial_cells);
...
bool cCells::operator==(const cCells & rhs) const
{
  if (!(plain_cells == rhs.plain_cells))
    return false;
  if (!(counter_cells == rhs.counter_cells))
...
void swap(KCellPlain &a, KCellPlain &b) noexcept {
  using ::std::swap;
  swap(a.c, b.c);
  swap(a.ts, b.ts);
  swap(a.v, b.v);
...
bool KCellPlain::operator==(const KCellPlain & rhs) const
{
  if (!(c == rhs.c))
    return false;
  if (!(ts == rhs.ts))
...
void swap(KCellCounter &a, KCellCounter &b) noexcept {
  using ::std::swap;
  swap(a.c, b.c);
  swap(a.ts, b.ts);
  swap(a.v, b.v);
...
bool KCellCounter::operator==(const KCellCounter & rhs) const
{
  if (!(c == rhs.c))
    return false;
  if (!(ts == rhs.ts))
...
void swap(KCellSerial &a, KCellSerial &b) noexcept {
  using ::std::swap;
  swap(a.c, b.c);
  swap(a.ts, b.ts);
  swap(a.v, b.v);
...
bool KCellSerial::operator==(const KCellSerial & rhs) const
{
  if (!(c == rhs.c))
    return false;
  if (!(ts == rhs.ts))
...
void swap(kCells &a, kCells &b) noexcept {
  using ::std::swap;
  swap(a.k, b.k);
  swap(a.plain_cells, b.plain_cells);
  swap(a.counter_cells, b.counter_cells);
...
bool kCells::operator==(const kCells & rhs) const
{
  if (!(k == rhs.k))
    return false;
  if (!(plain_cells == rhs.plain_cells))
...
void swap(FCellPlain &a, FCellPlain &b) noexcept {
  using ::std::swap;
  swap(a.c, b.c);
  swap(a.ts, b.ts);
  swap(a.v, b.v);
...
bool FCellPlain::operator==(const FCellPlain & rhs) const
{
  if (!(c == rhs.c))
    return false;
  if (!(ts == rhs.ts))
...
void swap(FCellCounter &a, FCellCounter &b) noexcept {
  using ::std::swap;
  swap(a.c, b.c);
  swap(a.ts, b.ts);
  swap(a.v, b.v);
...
bool FCellCounter::operator==(const FCellCounter & rhs) const
{
  if (!(c == rhs.c))
    return false;
  if (!(ts == rhs.ts))
...
void swap(FCellSerial &a, FCellSerial &b) noexcept {
  using ::std::swap;
  swap(a.c, b.c);
  swap(a.ts, b.ts);
  swap(a.v, b.v);
...
bool FCellSerial::operator==(const FCellSerial & rhs) const
{
  if (!(c == rhs.c))
    return false;
  if (!(ts == rhs.ts))
...
void swap(FCells &a, FCells &b) noexcept {
  using ::std::swap;
  swap(a.f, b.f);
  swap(a.plain_cells, b.plain_cells);
  swap(a.counter_cells, b.counter_cells);
...
bool FCells::operator==(const FCells & rhs) const
{
  if (!(f == rhs.f))
    return false;
  if (!(plain_cells == rhs.plain_cells))
...
void swap(CellsGroup &a, CellsGroup &b) noexcept {
  using ::std::swap;
...
bool CellsGroup::operator==(const CellsGroup & rhs) const
{
  if (!(cells == rhs.cells))
    return false;
...
void swap(CompactResult &a, CompactResult &b) noexcept {
  using ::std::swap;
  swap(a.cid, b.cid);
  swap(a.err, b.err);
  swap(a.__isset, b.__isset);
...
bool CompactResult::operator==(const CompactResult & rhs) const
{
  if (!(cid == rhs.cid))
    return false;
  if (!(err == rhs.err))
...
void swap(Result &a, Result &b) noexcept {
  using ::std::swap;
