...
public class CellPlain implements org.apache.thrift.TBase<CellPlain, CellPlain._Fields>, java.io.Serializable, Cloneable, Comparable<CellPlain> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CellPlain");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new CellPlainStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new CellPlainTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CellPlain.class, metaDataMap);
  }
   ...
   */
  public CellPlain(CellPlain other) {
   ...
   * The Column Name
   */
  public CellPlain setC(@org.apache.thrift.annotation.Nullable java.lang.String c) {
    this.c = c;
    return this;
  }
   ...
   * The Cell Key
   */
  public CellPlain setK(@org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> k) {
    this.k = k;
    return this;
  }
   ...
   * The Cell Timestamp
   */
  public CellPlain setTs(long ts) {
    this.ts = ts;
    setTsIsSet(true);
    return this;
  }
   ...
   * The Cell Value
   */
  public CellPlain setV(byte[] v) {
    this.v = v == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(v.clone());
    return this;
  }

  public CellPlain setV(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer v) {
    this.v = org.apache.thrift.TBaseHelper.copyBinary(v);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof CellPlain)
      return this.equals((CellPlain)that);
    return false;
  }

  public boolean equals(CellPlain that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(CellPlain other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("CellPlain(");
    boolean first = true;
  ...
  private static class CellPlainStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public CellPlainStandardScheme getScheme() {
      return new CellPlainStandardScheme();
    }
  }

  private static class CellPlainStandardScheme extends org.apache.thrift.scheme.StandardScheme<CellPlain> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, CellPlain struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.k = new java.util.ArrayList<java.nio.ByteBuffer>(_list352.size);
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem353;
                for (int _i354 = 0; _i354 < _list352.size; ++_i354)
                {
                  _elem353 = iprot.readBinary();
                  struct.k.add(_elem353);
                }
                iprot.readListEnd();
              }
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, CellPlain struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.k != null) {
        oprot.writeFieldBegin(K_FIELD_DESC);
        {
          ...
          for (java.nio.ByteBuffer _iter355 : struct.k)
          {
  ...
  private static class CellPlainTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public CellPlainTupleScheme getScheme() {
      return new CellPlainTupleScheme();
    }
  }

  private static class CellPlainTupleScheme extends org.apache.thrift.scheme.TupleScheme<CellPlain> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CellPlain struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetK()) {
        {
          ...
          for (java.nio.ByteBuffer _iter356 : struct.k)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CellPlain struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.k = new java.util.ArrayList<java.nio.ByteBuffer>(_list357.size);
