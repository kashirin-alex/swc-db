...
var _ = swcdb_thrift.GoUnusedProtection__
...
func main() {
  ...
  case "update_plain":
    ...
    containerStruct0 := swcdb_thrift.NewServiceUpdatePlainArgs()
  ...
  case "update_counter":
    ...
    containerStruct0 := swcdb_thrift.NewServiceUpdateCounterArgs()
  ...
  case "update_serial":
    ...
    containerStruct0 := swcdb_thrift.NewServiceUpdateSerialArgs()
  ...
  case "update_by_types":
    ...
    containerStruct0 := swcdb_thrift.NewServiceUpdateByTypesArgs()
    ...
    containerStruct1 := swcdb_thrift.NewServiceUpdateByTypesArgs()
    ...
    containerStruct2 := swcdb_thrift.NewServiceUpdateByTypesArgs()
