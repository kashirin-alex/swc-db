 ...
 */
public class SpecValueSerial_INT64 implements org.apache.thrift.TBase<SpecValueSerial_INT64, SpecValueSerial_INT64._Fields>, java.io.Serializable, Cloneable, Comparable<SpecValueSerial_INT64> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SpecValueSerial_INT64");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SpecValueSerial_INT64StandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SpecValueSerial_INT64TupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SpecValueSerial_INT64.class, metaDataMap);
  }
   ...
   */
  public SpecValueSerial_INT64(SpecValueSerial_INT64 other) {
  ...
  public SpecValueSerial_INT64 deepCopy() {
    return new SpecValueSerial_INT64(this);
  }
   ...
   * @see Comp
   */
  public SpecValueSerial_INT64 setComp(@org.apache.thrift.annotation.Nullable Comp comp) {
    this.comp = comp;
    return this;
  }
   ...
   * The int64 to match against the value field
   */
  public SpecValueSerial_INT64 setV(long v) {
    this.v = v;
    setVIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof SpecValueSerial_INT64)
      return this.equals((SpecValueSerial_INT64)that);
    return false;
  }

  public boolean equals(SpecValueSerial_INT64 that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(SpecValueSerial_INT64 other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SpecValueSerial_INT64(");
    boolean first = true;
  ...
  private static class SpecValueSerial_INT64StandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SpecValueSerial_INT64StandardScheme getScheme() {
      return new SpecValueSerial_INT64StandardScheme();
    }
  }

  private static class SpecValueSerial_INT64StandardScheme extends org.apache.thrift.scheme.StandardScheme<SpecValueSerial_INT64> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SpecValueSerial_INT64 struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SpecValueSerial_INT64 struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SpecValueSerial_INT64TupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SpecValueSerial_INT64TupleScheme getScheme() {
      return new SpecValueSerial_INT64TupleScheme();
    }
  }

  private static class SpecValueSerial_INT64TupleScheme extends org.apache.thrift.scheme.TupleScheme<SpecValueSerial_INT64> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SpecValueSerial_INT64 struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SpecValueSerial_INT64 struct) throws org.apache.thrift.TException {
