...
public partial class KCell : TBase
{
  ...
  {
    var tmp329 = new KCell();
    if((C != null) && __isset.c)
    {
      tmp329.C = this.C;
    }
    tmp329.__isset.c = this.__isset.c;
    if(__isset.ts)
    {
      tmp329.Ts = this.Ts;
    }
    tmp329.__isset.ts = this.__isset.ts;
    if((V != null) && __isset.v)
    {
      tmp329.V = this.V.ToArray();
    }
    tmp329.__isset.v = this.__isset.v;
    return tmp329;
  }
  ...
  {
    var tmp332 = new StringBuilder("KCell(");
    int tmp333 = 0;
    if((C != null) && __isset.c)
    {
