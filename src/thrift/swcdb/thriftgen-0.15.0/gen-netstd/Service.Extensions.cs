...
public static class ServiceExtensions
{
  ...
  public static Dictionary<byte[], FCells> DeepCopy(this Dictionary<byte[], FCells> source)
  {
    ...
    var tmp930 = new Dictionary<byte[], FCells>(source.Count);
    foreach (var pair in source)
      tmp930.Add((pair.Key != null) ? pair.Key.ToArray() : null, (pair.Value != null) ? pair.Value.DeepCopy() : null);
    return tmp930;
  }
  ...
  public static Dictionary<long, List<UCell>> DeepCopy(this Dictionary<long, List<UCell>> source)
  {
    ...
    var tmp931 = new Dictionary<long, List<UCell>>(source.Count);
    foreach (var pair in source)
      tmp931.Add(pair.Key, (pair.Value != null) ? pair.Value.DeepCopy() : null);
    return tmp931;
  }
  ...
  public static Dictionary<long, List<UCellSerial>> DeepCopy(this Dictionary<long, List<UCellSerial>> source)
  {
    ...
    var tmp932 = new Dictionary<long, List<UCellSerial>>(source.Count);
    foreach (var pair in source)
      tmp932.Add(pair.Key, (pair.Value != null) ? pair.Value.DeepCopy() : null);
    return tmp932;
  }
  ...
  public static Dictionary<string, ColCells> DeepCopy(this Dictionary<string, ColCells> source)
  {
    ...
    var tmp933 = new Dictionary<string, ColCells>(source.Count);
    foreach (var pair in source)
      tmp933.Add((pair.Key != null) ? pair.Key : null, (pair.Value != null) ? pair.Value.DeepCopy() : null);
    return tmp933;
  }
  ...
  public static List<CCell> DeepCopy(this List<CCell> source)
  {
    ...
    var tmp934 = new List<CCell>(source.Count);
  ...
  public static List<CCellSerial> DeepCopy(this List<CCellSerial> source)
  {
    ...
    var tmp935 = new List<CCellSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<Cell> DeepCopy(this List<Cell> source)
  {
    ...
    var tmp936 = new List<Cell>(source.Count);
    foreach (var elem in source)
  ...
  public static List<CellSerial> DeepCopy(this List<CellSerial> source)
  {
    ...
    var tmp937 = new List<CellSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<CellValueSerial> DeepCopy(this List<CellValueSerial> source)
  {
    ...
    var tmp938 = new List<CellValueSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<CompactResult> DeepCopy(this List<CompactResult> source)
  {
    ...
    var tmp939 = new List<CompactResult>(source.Count);
    foreach (var elem in source)
  ...
  public static List<FCell> DeepCopy(this List<FCell> source)
  {
    ...
    var tmp940 = new List<FCell>(source.Count);
    foreach (var elem in source)
  ...
  public static List<FCellSerial> DeepCopy(this List<FCellSerial> source)
  {
    ...
    var tmp941 = new List<FCellSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<KCell> DeepCopy(this List<KCell> source)
  {
    ...
    var tmp942 = new List<KCell>(source.Count);
    foreach (var elem in source)
  ...
  public static List<KCellSerial> DeepCopy(this List<KCellSerial> source)
  {
    ...
    var tmp943 = new List<KCellSerial>(source.Count);
    foreach (var elem in source)
  ...
  public static List<Schema> DeepCopy(this List<Schema> source)
  {
    ...
    var tmp944 = new List<Schema>(source.Count);
    foreach (var elem in source)
  ...
  public static List<SchemaPattern> DeepCopy(this List<SchemaPattern> source)
  {
    ...
    var tmp945 = new List<SchemaPattern>(source.Count);
    foreach (var elem in source)
      tmp945.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp945;
  }
  ...
  public static List<SpecColumn> DeepCopy(this List<SpecColumn> source)
  {
    ...
    var tmp946 = new List<SpecColumn>(source.Count);
    foreach (var elem in source)
  ...
  public static List<SpecColumnSerial> DeepCopy(this List<SpecColumnSerial> source)
  {
    ...
    var tmp947 = new List<SpecColumnSerial>(source.Count);
    foreach (var elem in source)
      tmp947.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp947;
  }
  ...
  public static List<SpecFraction> DeepCopy(this List<SpecFraction> source)
  {
    ...
    var tmp948 = new List<SpecFraction>(source.Count);
    foreach (var elem in source)
      tmp948.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp948;
  }
  ...
  public static List<SpecInterval> DeepCopy(this List<SpecInterval> source)
  {
    ...
    var tmp949 = new List<SpecInterval>(source.Count);
    foreach (var elem in source)
      tmp949.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp949;
  }
  ...
  public static List<SpecIntervalSerial> DeepCopy(this List<SpecIntervalSerial> source)
  {
    ...
    var tmp950 = new List<SpecIntervalSerial>(source.Count);
    foreach (var elem in source)
      tmp950.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp950;
  }
  ...
  public static List<SpecKeyInterval> DeepCopy(this List<SpecKeyInterval> source)
  {
    ...
    var tmp951 = new List<SpecKeyInterval>(source.Count);
    foreach (var elem in source)
      tmp951.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp951;
  }
  ...
  public static List<SpecValue> DeepCopy(this List<SpecValue> source)
  {
    ...
    var tmp952 = new List<SpecValue>(source.Count);
    foreach (var elem in source)
      tmp952.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp952;
  }
  ...
  public static List<SpecValueSerial> DeepCopy(this List<SpecValueSerial> source)
  {
    ...
    var tmp953 = new List<SpecValueSerial>(source.Count);
    foreach (var elem in source)
      tmp953.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp953;
  }
  ...
  public static List<SpecValueSerialField> DeepCopy(this List<SpecValueSerialField> source)
  {
    ...
    var tmp954 = new List<SpecValueSerialField>(source.Count);
    foreach (var elem in source)
      tmp954.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp954;
  }
  ...
  public static List<SpecValueSerial_BYTES> DeepCopy(this List<SpecValueSerial_BYTES> source)
  {
    ...
    var tmp955 = new List<SpecValueSerial_BYTES>(source.Count);
    foreach (var elem in source)
      tmp955.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp955;
  }
  ...
  public static List<SpecValueSerial_INT64> DeepCopy(this List<SpecValueSerial_INT64> source)
  {
    ...
    var tmp956 = new List<SpecValueSerial_INT64>(source.Count);
    foreach (var elem in source)
      tmp956.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp956;
  }
  ...
  public static List<UCell> DeepCopy(this List<UCell> source)
  {
    ...
    var tmp957 = new List<UCell>(source.Count);
    foreach (var elem in source)
      tmp957.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp957;
  }
  ...
  public static List<UCellSerial> DeepCopy(this List<UCellSerial> source)
  {
    ...
    var tmp958 = new List<UCellSerial>(source.Count);
    foreach (var elem in source)
      tmp958.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp958;
  }
  ...
  public static List<byte[]> DeepCopy(this List<byte[]> source)
  {
    ...
    var tmp959 = new List<byte[]>(source.Count);
    foreach (var elem in source)
      tmp959.Add((elem != null) ? elem.ToArray() : null);
    return tmp959;
  }
  ...
  public static List<kCells> DeepCopy(this List<kCells> source)
  {
    ...
    var tmp960 = new List<kCells>(source.Count);
    foreach (var elem in source)
      tmp960.Add((elem != null) ? elem.DeepCopy() : null);
    return tmp960;
  }
  ...
  public static List<long> DeepCopy(this List<long> source)
  {
    ...
    var tmp961 = new List<long>(source.Count);
    foreach (var elem in source)
      tmp961.Add(elem);
    return tmp961;
  }
  ...
  public static List<string> DeepCopy(this List<string> source)
  {
    ...
    var tmp962 = new List<string>(source.Count);
    foreach (var elem in source)
      tmp962.Add((elem != null) ? elem : null);
    return tmp962;
  }
