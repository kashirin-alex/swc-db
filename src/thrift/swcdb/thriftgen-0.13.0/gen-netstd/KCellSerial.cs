            ...
            {
              {
                ...
                V = new List<CellValueSerial>(_list164.Count);
                for(int _i165 = 0; _i165 < _list164.Count; ++_i165)
                {
                  CellValueSerial _elem166;
                  _elem166 = new CellValueSerial();
    ...
    try
    {
      ...
      if (V != null && __isset.v)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (CellValueSerial _iter167 in V)
          {
