...
public partial class SpecColumnSerial : TBase
{
            ...
            {
              {
                ...
                Intervals = new List<SpecIntervalSerial>(_list88.Count);
                for(int _i89 = 0; _i89 < _list88.Count; ++_i89)
                {
                  SpecIntervalSerial _elem90;
                  _elem90 = new SpecIntervalSerial();
                  await _elem90.ReadAsync(iprot, cancellationToken);
                  Intervals.Add(_elem90);
                }
    ...
    try
    {
      ...
      if (Intervals != null && __isset.intervals)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (SpecIntervalSerial _iter91 in Intervals)
          {
  ...
  {
    var other = that as SpecColumnSerial;
