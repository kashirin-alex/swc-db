            ...
            {
              {
                ...
                K = new List<byte[]>(_list128.Count);
            ...
            {
              {
                ...
                V = new List<CellValueSerial>(_list131.Count);
                for(int _i132 = 0; _i132 < _list131.Count; ++_i132)
                {
                  CellValueSerial _elem133;
                  _elem133 = new CellValueSerial();
    ...
    try
    {
      ...
      if (K != null && __isset.k)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (byte[] _iter134 in K)
          {
            await oprot.WriteBinaryAsync(_iter134, cancellationToken);
          }
      ...
      if (V != null && __isset.v)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (CellValueSerial _iter135 in V)
          {
