...
public partial class SpecValueSerialField : TBase
{
  ...
  {
    var other = that as SpecValueSerialField;
  ...
  public override string ToString()
  {
    ...
    if (Spec_int64 != null && __isset.spec_int64)
    {
      ...
      sb.Append(Spec_int64== null ? "<null>" : Spec_int64.ToString());
    }
    if (Spec_double != null && __isset.spec_double)
    {
      if(!__first) { sb.Append(", "); }
      ...
      sb.Append(Spec_double== null ? "<null>" : Spec_double.ToString());
    }
    if (Spec_bytes != null && __isset.spec_bytes)
    {
      if(!__first) { sb.Append(", "); }
      ...
      sb.Append(Spec_bytes== null ? "<null>" : Spec_bytes.ToString());
    }
    if (Spec_key != null && __isset.spec_key)
    {
      if(!__first) { sb.Append(", "); }
      __first = false;
      sb.Append("Spec_key: ");
      sb.Append(Spec_key== null ? "<null>" : Spec_key.ToString());
    }
    if (Spec_li != null && __isset.spec_li)
    {
      if(!__first) { sb.Append(", "); }
      __first = false;
      sb.Append("Spec_li: ");
      sb.Append(Spec_li== null ? "<null>" : Spec_li.ToString());
    }
    if (Spec_lb != null && __isset.spec_lb)
    {
      if(!__first) { sb.Append(", "); }
      __first = false;
      sb.Append("Spec_lb: ");
      sb.Append(Spec_lb== null ? "<null>" : Spec_lb.ToString());
    }
    sb.Append(")");
    return sb.ToString();
  }
