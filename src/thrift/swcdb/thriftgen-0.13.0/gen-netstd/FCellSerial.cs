            ...
            {
              {
                ...
                V = new List<CellValueSerial>(_list180.Count);
                for(int _i181 = 0; _i181 < _list180.Count; ++_i181)
                {
                  CellValueSerial _elem182;
                  _elem182 = new CellValueSerial();
    ...
    try
    {
      ...
      if (V != null && __isset.v)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (CellValueSerial _iter183 in V)
          {
