...
public class CellValueSerial implements org.apache.thrift.TBase<CellValueSerial, CellValueSerial._Fields>, java.io.Serializable, Cloneable, Comparable<CellValueSerial> {
  ...
  public int compareTo(CellValueSerial other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetV_int64()).compareTo(other.isSetV_int64());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetV_int64()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetV_double()).compareTo(other.isSetV_double());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetV_double()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetV_bytes()).compareTo(other.isSetV_bytes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetV_bytes()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetV_key()).compareTo(other.isSetV_key());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetV_key()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetV_li()).compareTo(other.isSetV_li());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetV_li()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetV_lb()).compareTo(other.isSetV_lb());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetV_lb()) {
  ...
  private static class CellValueSerialTupleScheme extends org.apache.thrift.scheme.TupleScheme<CellValueSerial> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CellValueSerial struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list226 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
