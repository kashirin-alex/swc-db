...
public class SpecValueSerialField implements org.apache.thrift.TBase<SpecValueSerialField, SpecValueSerialField._Fields>, java.io.Serializable, Cloneable, Comparable<SpecValueSerialField> {
  ...
  public int compareTo(SpecValueSerialField other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSpec_int64()).compareTo(other.isSetSpec_int64());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSpec_int64()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSpec_double()).compareTo(other.isSetSpec_double());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSpec_double()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSpec_bytes()).compareTo(other.isSetSpec_bytes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSpec_bytes()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSpec_key()).compareTo(other.isSetSpec_key());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSpec_key()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSpec_li()).compareTo(other.isSetSpec_li());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSpec_li()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSpec_lb()).compareTo(other.isSetSpec_lb());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSpec_lb()) {
