          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                xfer += ret;
                g_ptr_array_add (*_return, _elem51);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                xfer += ret;
                g_ptr_array_add (*_return, _elem52);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &key53, error)) < 0)
                  return 0;
                xfer += ret;
                {
                  guint32 size;
                ...
                if (*_return && key53)
                  g_hash_table_insert ((GHashTable *)*_return, (gpointer) key53, (gpointer) val54);
              }
