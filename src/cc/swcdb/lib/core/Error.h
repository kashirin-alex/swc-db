...
namespace SWC {
  ...
  #define CODE_START 0x800  
    ...
    enum Code {
      ...
      IO_ERROR                                     = CODE_START+1,
      BAD_MEMORY_ALLOCATION                        = CODE_START+2,

      PROTOCOL_ERROR                               = CODE_START+3,
      REQUEST_TRUNCATED_HEADER                     = CODE_START+4,
      REQUEST_TRUNCATED_PAYLOAD                    = CODE_START+5,
      REQUEST_TIMEOUT                              = CODE_START+6,
      REQUEST_MALFORMED                            = CODE_START+7,
      NOT_IMPLEMENTED                              = CODE_START+0xa,
      VERSION_MISMATCH                             = CODE_START+0xb,
      CHECKSUM_MISMATCH                            = CODE_START+0xc,
      ...
      SCHEMA_PARSE_ERROR                           = CODE_START+20+2,
      BAD_SCAN_SPEC                                = CODE_START+20+3,
      BAD_SCHEMA                                   = CODE_START+20+4,
      BAD_KEY                                      = CODE_START+20+5,

      BLOCK_COMPRESSOR_UNSUPPORTED_TYPE            = CODE_START+30+0,
      BLOCK_COMPRESSOR_INVALID_ARG                 = CODE_START+30+1,
      BLOCK_COMPRESSOR_TRUNCATED                   = CODE_START+30+2,
      BLOCK_COMPRESSOR_BAD_HEADER                  = CODE_START+30+3,
      BLOCK_COMPRESSOR_BAD_MAGIC                   = CODE_START+30+4,
      BLOCK_COMPRESSOR_CHECKSUM_MISMATCH           = CODE_START+30+5,
      BLOCK_COMPRESSOR_DEFLATE_ERROR               = CODE_START+30+6,
      BLOCK_COMPRESSOR_INFLATE_ERROR               = CODE_START+30+7,
      BLOCK_COMPRESSOR_INIT_ERROR                  = CODE_START+30+8,
