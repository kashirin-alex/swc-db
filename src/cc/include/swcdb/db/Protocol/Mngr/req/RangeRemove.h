...
#ifndef swc_lib_db_protocol_req_RangeRemove_h
#define swc_lib_db_protocol_req_RangeRemove_h
...
class RangeRemove: public Common::Req::ConnQueue::ReqBase {
  public:
...
#endif // swc_lib_db_protocol_req_RangeRemove_h
