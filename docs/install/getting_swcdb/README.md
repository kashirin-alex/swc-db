...
```bash
SWCDB_VERSION="0.5.9";
SWCDB_VERSION_SPECIFIC="Ubuntu_20_04_3_LTS.amd64";
...
|     ---     |          ---                       |       ---         |        ---        |     ---     | ---                                 |  ---           |
| 0.5.9       | debug.amd64                        | tar.xz            | debug             | GCC-11.2    | GLIBC-2.27 amd64                    | [download](https://github.com/kashirin-alex/swc-db/releases/download/v0.5.9/swcdb-0.5.9.debug.amd64.tar.xz) |
| 0.5.9       | amd64                              | tar.xz            | standard          | GCC-11.2    | GLIBC-2.27 amd64                    | [download](https://github.com/kashirin-alex/swc-db/releases/download/v0.5.9/swcdb-0.5.9.amd64.tar.xz) |
| 0.5.9       | optimized.amd64                    | tar.xz            | optimized         | GCC-11.2    | GLIBC-2.27 amd64                    | [download](https://github.com/kashirin-alex/swc-db/releases/download/v0.5.9/swcdb-0.5.9.optimized.amd64.tar.xz) |
| 0.5.9       | Ubuntu_20_04_3_LTS.amd64           | deb               | standard          | GCC-9.3     | GLIBC-2.31 Ubuntu-20.04.3 LTS amd64    | [download](https://github.com/kashirin-alex/swc-db/releases/download/v0.5.9/swcdb-0.5.9.Ubuntu_20_04_3_LTS.amd64.deb) |
|             |                       |                   |                   |             |                                     |                 |
