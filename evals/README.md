...
Dated scored audits of the SWC-DB codebase and user docs. These are **snapshots** (evidence + scores + backlog), not day-to-day agent policy.

| Report | Focus |
|--------|--------|
| [`STANDARDS_CLARITY_EVALUATION.md`](STANDARDS_CLARITY_EVALUATION.md) | Hand-written vs Thrift-generated standards/clarity (Layer A/B) |
