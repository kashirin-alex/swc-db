...
**_The Described details are of the SWC-DB package [`swcdb-0.4.17.Ubuntu_20_04_1_LTS.amd64.deb`](https://github.com/kashirin-alex/swc-db/releases/download/v0.4.17/swcdb-0.4.17.Ubuntu_20_04_1_LTS.amd64.deb)._**
...
* Install with `dpkg -i swcdb-0.4.17.Ubuntu_20_04_1_LTS.amd64.deb;`
