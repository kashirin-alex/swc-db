...
**_The Described details are of the SWC-DB package [`swcdb-0.5.8.Ubuntu_20_04_3_LTS.amd64.deb`](https://github.com/kashirin-alex/swc-db/releases/download/v0.5.8/swcdb-0.5.8.Ubuntu_20_04_3_LTS.amd64.deb)._**
...
* Install with `dpkg -i swcdb-0.5.8.Ubuntu_20_04_3_LTS.amd64.deb;`
