...
**_The Described details are of the SWC-DB package [`swcdb-0.4.18.Ubuntu_20_04_2_LTS.amd64.deb`](https://github.com/kashirin-alex/swc-db/releases/download/v0.4.18/swcdb-0.4.18.Ubuntu_20_04_2_LTS.amd64.deb)._**
...
* Install with `dpkg -i swcdb-0.4.18.Ubuntu_20_04_2_LTS.amd64.deb;`
