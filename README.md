...
Usage Help:  'command' [options];
  ...
  select           select where [Columns[Cells[Interval Flags]]] Flags Display-Flags;
  ...
  dump             dump col='ID|NAME' into 'file.ext' where [cells=(Interval Flags) AND] Output-Flags Display-Flags;
                   -> dump col='ColName' into 'ColName.tsv' OUTPUT_NO_* TS / VALUE;
  load             load from 'file.ext' into col='ID|NAME' Display-Flags;
SWC-DB(client)>
